            ...
            child: Stack(
              children: <Widget>[
                TabBarView(
                  ...
                  children: <Widget>[
                    Image.network(
                        "https://assets.simplecast.com/assets/fallback/default-b7824fcd998f51baf0f0af359a72e760.png",
                    ),
                  ],
                ),
                Container(
    ...
    return Padding(
      ...
      child: Text(
        "Product Id: " + widget.product.id.toString() +
            ...
            "\nCreated At: " + widget.product.created +
            "\nUpdated At: " + widget.product.updated,
//            "\nDeleted At: " + widget.product.deleted ,
//        "test",
        style: TextStyle(
          color: Colors.grey[600],
        ),
